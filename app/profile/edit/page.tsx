    ...
    <div className="min-h-screen bg-[#F5F0E8] px-4 py-8 pb-24">
      <div className="max-w-md mx-auto">
        ...
        <div className="flex items-center gap-3 mb-6">
          <button onClick={() => router.push('/profile')} className="text-gray-500 text-xl">←</button>
          <h1 className="text-xl font-bold text-gray-800">프로필 수정</h1>
        </div>

        {/* 닉네임 */}
        <div className="bg-white rounded-2xl p-6 shadow-sm mb-4">
          <p className="text-sm font-medium text-gray-700 mb-2">닉네임</p>
          <input
            type="text"
            value={nickname}
        ...
        {/* 체온 민감도 */}
        <div className="bg-white rounded-2xl p-6 shadow-sm mb-4">
          <p className="text-sm font-medium text-gray-700 mb-3">체온 민감도</p>
          <div className="space-y-2">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm mb-6">
          <p className="text-sm font-medium text-gray-700 mb-3">기본 위치</p>
            ...
            <div className="border border-gray-100 rounded-xl overflow-hidden mb-3">
              {addressResults.map((result, i) => (
                <button
                  ...
                  className="w-full text-left px-4 py-3 text-sm border-b border-gray-50 last:border-0 hover:bg-gray-50"
                >
                  {result.address}
                </button>
              ))}
          ...
          {selectedAddress && (
            <div className="bg-[#F5F0E8] rounded-xl px-4 py-3 text-sm text-[#2C5F2E]">
